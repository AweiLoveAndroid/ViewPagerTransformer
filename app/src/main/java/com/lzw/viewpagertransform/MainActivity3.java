...
import com.lzw.viewpagertransform.fragment.Main3PagerAdapter;
import com.lzw.viewpagertransform.transform.viewpager.CustomViewPager;
import com.lzw.viewpagertransform.transform.banner.ITransformer;
import com.lzw.viewpagertransform.widget.FlowLayout;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    private void initViewPager() {
        ...
        mViewPager.setScrollDirection(true);
...
//            当页面开始滑动的时候，三种状态的变化顺序为1-->2-->0
            ...
            public void onPageScrollStateChanged(int state) {
                if(state == 2){
                    ...
                    initFlowLayoutListener(mViewPager);
                }
            }
        });
    }
    ...
    private void initFlowLayout() {
        mFlowLayout = (FlowLayout) findViewById(R.id.flowlayout_main3);
     ...
     * FlowLayout监听器
     */
    public void initFlowLayoutListener(final CustomViewPager viewPager){
